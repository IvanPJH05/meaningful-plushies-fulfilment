...
export function MonthlyJournalInbox() {
  ...
  return <div className="monthly-inbox">
    ...
    <div className="mj-shortcuts"><b>{selected.length} selected unposted row(s)</b><button onClick={() => void shortcut("Credit sales")}>Credit sales</button><button onClick={() => void shortcut("Shopify subscription - previous month")}>Shopify subscription - previous month</button><button onClick={() => setSelected([])}>Clear selection</button></div>
