(() => {
  document.querySelectorAll("[data-customisation-block]").forEach((block) => {
    ...
    const fillLaterDisabled = block.dataset.fillLaterDisabled === "true";
    ...
    const restoreDraft = async () => {
      try {
        ...
        if (saved) {
          ...
          const choice = !fillLaterDisabled && [...radios].find((radio) => radio.value === saved.choice);
    ...
    const isLater = () => !fillLaterDisabled && [...radios].some((radio) => radio.checked && radio.value === "later");
