...
export default function Home() {
  ...
  function fulfilmentCell(order: Order, column: FulfilmentColumn) {
    ...
    if (column === "meaningfulMessage") {
      ...
      return link ? <a href={link} target="_blank" rel="noreferrer">Open message</a> : "-";
    }
