...
type View =
  ...
  | "monthly_journal_inbox" | "monthly_journal_import" | "monthly_journal_shopee" | "monthly_journal_shortcuts" | "monthly_journal_general_journal" | "monthly_journal_accounts" | "monthly_journal_account_activity"
...
const monthlyJournalViews: readonly View[] = ["monthly_journal_inbox", "monthly_journal_import", "monthly_journal_shopee", "monthly_journal_shortcuts", "monthly_journal_general_journal", "monthly_journal_account_activity", "monthly_journal_accounts"];
...
export default function Home() {
  ...
  return <main className="app-shell">
    ...
    <section className="main-area">
      ...
      {workspace === "monthly_journal" && session.role === "admin" && <MonthlyJournalWorkspace initialView={view.replace("monthly_journal_", "") as "inbox" | "import" | "shopee" | "shortcuts" | "general_journal" | "account_activity" | "accounts"} />}
